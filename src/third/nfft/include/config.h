...
#define ABS_SRCDIR "/data/Work/pbmoma/src/third/nfft/."
...
/* Define to enable MRImodule. */
/* #undef HAVE_MRI */

/* Define to 1 if you have the `nanosleep' function. */
#define HAVE_NANOSLEEP 1

/* Define to enable NFCTmodule. */
/* #undef HAVE_NFCT */

/* Define to enable NFSFTmodule. */
/* #undef HAVE_NFSFT */

/* Define to enable NFSOFTmodule. */
/* #undef HAVE_NFSOFT */

/* Define to enable NFSTmodule. */
/* #undef HAVE_NFST */

/* Define to enable NNFFTmodule. */
/* #undef HAVE_NNFFT */

/* Define to enable NSFFTmodule. */
/* #undef HAVE_NSFFT */
...
/* Define to enable exhaustive unit tests. */
/* #undef NFFT_EXHAUSTIVE_UNIT_TESTS */
...
#define NFFT_VERSION_MINOR 3

/* Patch version number. */
#define NFFT_VERSION_PATCH 1

/* Release type. */
#define NFFT_VERSION_TYPE 
...
#define PACKAGE_BUGREPORT "mail@nfft.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "NFFT"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "NFFT 3.3.1"
